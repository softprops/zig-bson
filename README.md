...
```sh
zig fetch --save https://github.com/softprops/zig-bson/archive/refs/tags/v0.1.2.tar.gz
```
...
+        .bson = .{
+            // 👇 uri to download
+            .url = "https://github.com/softprops/zig-bson/archive/refs/tags/v0.1.2.tar.gz",
+            // 👇 hash verification
+            .hash = "...",
+        },
    },
